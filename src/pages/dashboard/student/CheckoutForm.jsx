...
const CheckoutForm = ({ price, selectedData }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (paymentIntent.status === "succeeded") {
      ...
      const payment = {
        ...
        selectedIClassesIds: selectedData.map((item) => item._id),
        classItemsIds: selectedData.map((item) => item.selectedId),
        classNames: selectedData.map((item) => item.className),
      };
